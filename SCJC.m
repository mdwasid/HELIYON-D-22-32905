%% Single Criteria approach based on extended Jaccard Coefficient (SCJC)
    ...
    for actuser=1 :db_size(1) %number of users
        ...
        for g = 1:db_size(1)
            if g ~= actuser
                ...
                %% Caclulating the similarity among different users using extended Jaccard Coefficient
                check =0 ; denoL=0; denoR=0; % denominator of extended Jaccard Coefficient
        ...
        for top_k=10:10:70
            ...
            if pi ~=0
                ...
                actuser_corpred(actuser,x)=correct;
            else
