%% Single Criteria approach based on Common Rating weight Similarity (SCCRS)
    ...
    for actuser=1 :db_size(1) %number of users
        ...
        for g = 1:db_size(1)
            if g ~= actuser
                ...
                %% Caclulating the similarity among different users using common rating weight similarity
