%% Clustering with Fuzzy Side Information approach (Clust-FSI) 
...
filename='Clusters_FSI.xlsx'; 
% % Clusters obtained through clustering users through fuzzy side information
